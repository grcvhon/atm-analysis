...
# based on ocean bearing (direction) using spatially balanced points
...
library(utils)
write.csv(df_ovr, filename = paste0(dir, "sbs_seed",seed,"_",n_base,"pts_",format(Sys.time(),"%Hh%Mm%Ss"),".csv"))
