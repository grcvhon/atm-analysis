...
# barplot of ancestry coefficients at K = 2
algatr::tess_ggbarplot(laevis_qmat)
...
# Not run
#
# dos_k <- matrix(nrow = 5, ncol = 1)
# for (i in 1:5){
#   a <- algatr::tess_ktest(gen = laevis_dosage, 
#                        coords = laevis_nw_proj, 
#                        Kvals = 1:7, 
#                        ploidy = 2, 
#                        K_selection = "auto")
...
# }
# 
# imp_k <- matrix(nrow = 5, ncol = 1)
# for (i in 1:5){
#   a <- algatr::tess_ktest(gen = laevis_dos_imp, 
#                           coords = laevis_nw_proj, 
#                           Kvals = 1:7, 
#                           ploidy = 2, 
#                           K_selection = "auto")
